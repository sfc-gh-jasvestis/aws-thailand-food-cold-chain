  ...
  const executiveCockpit = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="Cold Chain Compliance" value={kpiVal('Cold Chain Compliance', '94.2%')} status="warning" />
        <KPICard title="Product Loss (QTD)" value={kpiVal('Product Loss (QTD)', '฿180M')} status="danger" />
        <KPICard title="Predicted Failures (7d)" value={kpiVal('Predicted Failures (7d)', '12')} status="warning" />
        <KPICard title="Active Shipments" value={kpiVal('Active Shipments', '835')} status="neutral" />
      </div>
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="lg:col-span-1">
          <GeoMap
            country="thailand"
            labels={{ entity: 'Routes', event: 'Temperature Readings', alert: 'Excursions' }}
      ...
      <DataTable
        columns={[
          ...
          { key: 'm1', header: 'Current °C' },
          { key: 'm2', header: 'Transit Temp' },
          { key: 'm3', header: 'On Time Delivery' },
          { key: 'events', header: 'Temperature Readings' },
  ...
  const domainTab1 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard title="Avg Transit Temp" value={kpiVal('Avg Transit Temp', '-18.3°C')} />
        <KPICard title="Door-Open Events Today" value={kpiVal('Door-Open Events Today', '47')} />
        <KPICard title="On-Time Delivery" value={kpiVal('On-Time Delivery', '91.8%')} />
      </div>
      <Chart
